...
## User Story 3: As a Registered User I want to CREATE a new post so that I can sell my items.
...
## User Story 4: As a Registered User I want to PREVIEW ALL CREATED POSTS in app so that I can choose one of them.
Datum početka rada: 15.07.2020 <br> 
